...
["set <JAIL> ipv6banprefix <VALUE>", "sets the network prefix that is used when banning IPv6 addresses for <JAIL>"],
...
["get <JAIL> ipv6banprefix", "gets the network prefix used when banning IPv6 addresses for <JAIL>"],
