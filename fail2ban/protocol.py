...
["set <JAIL> inactivesleep on|off", "tells a <JAIL> to use inactive sleeps"],
["set <JAIL> sleeptime <TIME>", "sets the number of seconds <TIME> a <JAIL> will wait between two wakeups"], 
...
["get <JAIL> inactivesleep", "tells if a <JAIL> is using inactive sleeps"],
["get <JAIL> sleeptime", "gets the time a <JAIL> is sleeping between two actions"],
