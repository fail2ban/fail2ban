...
["set <JAIL> addresetregex <INDEX>", "adds the regular expression at <INDEX> for resetregex"], 
["set <JAIL> delresetregex <INDEX>", "removes the regular expression at <INDEX> for resetregex"], 
...
["get <JAIL> resetregex", "gets the list of regular expressions which matches patterns to reset for <JAIL>"],
